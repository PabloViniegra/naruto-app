...
interface VillageCardSkeletonProps {
...
interface VillagesSkeletonProps {
  count?: number;
  className?: string;
}

export function VillagesSkeleton({ count = 12, className }: VillagesSkeletonProps) {
